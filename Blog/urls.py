...
urlpatterns = [
    ...
    path('edit-comments/',EditarComentarios.as_view(), name='editar_comentarios'),
    path('delete-comments/',EliminarComentarios.as_view(), name='eliminar_comentarios'),
    path('subcomentario/',SubComentar.as_view(), name='nuevo_subcomentario'),
    path('article-nuevo-like/',ArticleLike, name='nuevo_like'),
    path('article-nuevo-dislike/',ArticleDislike, name='nuevo_dislike'),
